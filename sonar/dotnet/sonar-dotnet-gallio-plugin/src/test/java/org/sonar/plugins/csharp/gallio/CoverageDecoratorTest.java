...
public class CoverageDecoratorTest {
  ...
  public void testShouldNotExecuteOnProjectIfSkip() throws Exception {
    conf.setProperty(GallioConstants.MODE, AbstractDotNetSensor.MODE_SKIP);
  ...
  private UnitCoverageDecorator createDecorator() {
    UnitCoverageDecorator decorator = new UnitCoverageDecorator(new DotNetConfiguration(conf), microsoftWindowsEnvironment, resourceHelper);
    return decorator;
  }
}
