...
public class GendarmeViolationMakerTest {
  ...
  private static DotNetResourceBridges bridges;
  ...
  public static void init() {
    ...
    bridges = new DotNetResourceBridges(new DotNetResourceBridge[] {createFakeBridge()});
  }

  @Before
  public void reinitViolationMaker() {
    context = mock(SensorContext.class);
    violationMaker = new GendarmeViolationMaker(env, project, context, bridges, resourceHelper);
